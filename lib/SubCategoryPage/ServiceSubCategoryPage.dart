...
class ServiceSubCategoryPage extends StatefulWidget {
  String id;
  @override
  _ServiceSubCategoryPageState createState() => _ServiceSubCategoryPageState();

  ServiceSubCategoryPage({this.id}) {
    print("IDD:"+this.id);
  }
}
...
class _ServiceSubCategoryPageState extends State<ServiceSubCategoryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        backgroundColor: orangeTheme,
        body: FutureBuilder<ProductData.ProductModel>(
            future: _subCategoryRepository.getProductBySubCategory(widget.id),
